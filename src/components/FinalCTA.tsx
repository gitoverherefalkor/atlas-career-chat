...
const FinalCTA = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-atlas-blue via-atlas-teal to-atlas-teal text-white">
      <div className="container-atlas text-center">
        ...
        <Button className="bg-gradient-to-r from-atlas-blue to-atlas-teal hover:from-atlas-teal hover:to-atlas-blue text-white text-lg py-6 px-10 inline-flex items-center gap-2">
