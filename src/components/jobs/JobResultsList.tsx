      ...
      {completedResults.map((result) => (
        <div key={result.sectionType}>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{result.careerTitle}</h3>
          ...
          {result.jobs.length > 0 ? (
            ...
            <div className="text-center py-8 border border-dashed border-gray-300 dark:border-gray-600 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 text-sm">No job openings found for this career in your area.</p>
              <p className="text-gray-400 dark:text-gray-400 text-xs mt-1">Try expanding your search location or check back later.</p>
            </div>
          )}
        </div>
      ))}
