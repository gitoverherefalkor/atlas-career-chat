...
const Hero = () => {
  return <section className="bg-gradient-to-br from-blue-50 via-indigo-50 to-atlas-navy pt-20 pb-32">
      <div className="container-atlas">
        ...
        {/* Two columns with images aligned at top and bottom */}
        <div className="grid lg:grid-cols-2 gap-10">
          {/* Left column: Image */}
          <div className="flex flex-col h-full">
            {/* Woman image - full height container */}
            <div className="relative rounded-lg overflow-hidden h-full flex flex-col">
              ...
              {/* Paragraphs under image, pushing to bottom */}
              <div className="mt-8">
          ...
          <div className="flex flex-col h-full">
            {/* Chat example - matched height with woman image */}
