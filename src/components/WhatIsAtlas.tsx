...
const WhatIsAtlas = () => {
  ...
  return (
    <section id="what-is-atlas" className="section">
      <div className="container-atlas">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Atlas Assessment is an advanced AI career guidance system that combines psychological insights with
            practical career mapping to help you find fulfilling work that aligns with your unique profile.
          </p>
        </div>
